...
//  Copyright © 2021 Imagin soft. All rights reserved.
//
    ...
    func toolbar(_ toolbar: NSToolbar,
        ...
        switch itemIdentifier {
            ...
            case NSToolbarItem.Identifier.calendar:
                    let button = NSButton(image: NSImage(systemSymbolName: "calendar", accessibilityDescription: nil)!, target: nil, action: nil)
