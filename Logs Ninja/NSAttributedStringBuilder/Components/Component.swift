#if canImport(UIKit)
import UIKit
public typealias ASize = CGSize
#elseif canImport(AppKit)
import AppKit
public typealias ASize = NSSize
#endif
...
extension Component {
    public func backgroundColor(_ color: AColor) -> Component {
    ...
    public func font(_ font: AFont) -> Component {
        attributes([.font: font])
    }

    public func foregroundColor(_ color: AColor) -> Component {
    ...
    public func shadow(color: AColor? = nil, radius: CGFloat, x: CGFloat, y: CGFloat) -> Component {
        let shadow = NSShadow()
    ...
    public func strikethrough(style: NSUnderlineStyle, color: AColor? = nil) -> Component {
        if let color = color {
    ...
    public func stroke(width: CGFloat, color: AColor? = nil) -> Component {
        if let color = color {
    ...
    public func underline(_ style: NSUnderlineStyle, color: AColor? = nil) -> Component {
        if let color = color {
